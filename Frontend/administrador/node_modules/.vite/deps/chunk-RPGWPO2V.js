...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function useTransition({
  ...
  const isInitialRef = (0, import_react3.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react3.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react3.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react4.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react4.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react4.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react4.useState)(!show);
  const lastFocusRef = (0, import_react4.useRef)(null);
  (0, import_react4.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react4.useRef)();
  const removeKeydownListenerRef = (0, import_react4.useRef)();
...
var AbstractModalHeader = React5.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context = (0, import_react5.useContext)(ModalContext_default);
...
var ModalHeader = React6.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React7.forwardRef((p, ref) => (0, import_jsx_runtime9.jsx)("div", {
  ...p,
  ref,
...
var Modal2 = React8.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react6.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react6.useState)(false);
  const waitingForMouseUpRef = (0, import_react6.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react6.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react6.useRef)(null);
  ...
  const renderBackdrop = (0, import_react6.useCallback)((backdropProps) => (0, import_jsx_runtime10.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime10.jsx)("div", {
    ...
    className: (0, import_classnames4.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    onClick: backdrop ? handleClick : void 0,
    onMouseUp: handleMouseUp,
    "aria-label": ariaLabel,
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime10.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime10.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
//# sourceMappingURL=chunk-RPGWPO2V.js.map
