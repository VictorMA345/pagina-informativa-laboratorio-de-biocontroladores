...
import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-4EZFNUBG.js";
import {
  Col_default,
  useCol
} from "./chunk-HXQDSKX2.js";
import {
  Container_default
} from "./chunk-5ERHPCQN.js";
import {
  Button_default,
...
import {
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-BEW5QOQZ.js";
import {
  require_jsx_runtime
} from "./chunk-SIKN2B7D.js";
import {
  require_prop_types
...
var Anchor = React10.forwardRef((_ref, ref) => {
  let {
    onKeyDown
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react19.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react20.useRef)(modifiers);
  const popperInstanceRef = (0, import_react20.useRef)();
  const update = (0, import_react20.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react20.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react20.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react20.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react20.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react21.useRef)(false);
  const waitingForTrigger = (0, import_react21.useRef)(false);
  const handleMouseCapture = (0, import_react21.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react22.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react22.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react23.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react23.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react23.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react23.useState)(true);
  let value = (0, import_react23.useMemo)(() => ({
  ...
  return (0, import_react23.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react23.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react23.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react23.default).createElement((0, import_react23.default).Fragment, null, props.children);
  }
  return (0, import_react23.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react24.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react24.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react25.useContext)(SelectableContext_default);
  const navContext = (0, import_react25.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react26.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react26.useRef)(null);
  const focusInDropdown = (0, import_react26.useRef)(false);
  const onSelectCtx = (0, import_react26.useContext)(SelectableContext_default);
  const toggle = (0, import_react26.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener((0, import_react26.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react27.useCallback)((refValue) => {
...
var DropdownMenu2 = React46.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react28.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react28.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React47.forwardRef(({
  ...
  const dropdownContext = (0, import_react29.useContext)(DropdownContext_default);
...
var FormGroup = React61.forwardRef(({
  ...
  const context5 = (0, import_react35.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var Switch = React66.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = React76.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react40.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react40.useState)(false);
  const waitingForMouseUpRef = (0, import_react40.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react40.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react40.useRef)(null);
  ...
  const renderBackdrop = (0, import_react40.useCallback)((backdropProps) => (0, import_jsx_runtime77.jsx)("div", {
    ...backdropProps,
...
var NavItem = React77.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime79.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames62.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav = React79.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react41.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react41.useContext)(CardHeaderContext_default);
  if (navbarContext) {
  ...
  return (0, import_jsx_runtime80.jsx)(Nav_default, {
    ...
    ref,
    activeKey,
    className: (0, import_classnames63.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavDropdown = React80.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React81.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
  ...
  const [exited, setExited] = (0, import_react43.useState)(!props.show);
...
var PopoverHeader = React82.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React83.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime85.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime85.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime88.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime87.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime87.jsx)("div", {
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react44.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React87.forwardRef(({
  ...
  const popperRef = (0, import_react45.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react45.useState)(null);
  ...
  return (0, import_jsx_runtime89.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react46.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react46.useRef)("");
  ...
  const handleShow = (0, import_react46.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react46.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react46.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react46.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react46.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react46.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react46.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(import_jsx_runtime91.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react46.cloneElement)(children, triggerProps), (0, import_jsx_runtime90.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime93.jsx)("li", {
    ...
    children: (0, import_jsx_runtime94.jsxs)(Component2, {
      className: (0, import_classnames70.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime93.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React89.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime94.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime95.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React91.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime96.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime98.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var ProgressBar = React93.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react47.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Spinner = React95.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React96.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react48.useContext)(TabContext_default);
  if (!context5)
...
var TabPanel = React98.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react49.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react49.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React101.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastFade = React105.forwardRef((props, ref) => (0, import_jsx_runtime112.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React106.createContext({
...
var ToastHeader = React107.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context5 = (0, import_react50.useContext)(ToastContext_default);
...
var ToastBody = React108.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React109.forwardRef(({
  ...
  const delayRef = (0, import_react51.useRef)(delay);
  const onCloseRef = (0, import_react51.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react51.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react51.useMemo)(() => ({
    onClose
  }), [onClose]);
