...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-FB4PHQRU.js";
import {
  Container_default
} from "./chunk-LJF5YAEK.js";
import {
  DEFAULT_BREAKPOINTS,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react32.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
